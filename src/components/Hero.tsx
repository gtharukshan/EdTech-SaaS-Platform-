      ...
      <div className="relative max-w-[1700px] mx-auto px-4 sm:px-8 lg:px-12 w-full z-10">
        ...
        >
          <div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-pill text-xs sm:text-sm text-slate-800 dark:text-white/80 border border-slate-300 dark:border-white/10 hover:border-[#00D6FF]/40 transition-all cursor-pointer group shadow-sm dark:shadow-[0_0_15px_rgba(0,214,255,0.1)]"
          >
            ...
            <span className="text-slate-600 dark:text-white/70 group-hover:text-slate-900 dark:group-hover:text-white flex items-center gap-1">
              ...
              <ArrowRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-1 text-[#0050FF] dark:text-[#00D6FF]" />
            </span>
          </div>
        </motion.div>
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="relative w-full sm:w-auto px-8 py-4 rounded-full bg-slate-900 dark:bg-[#050505]/10 backdrop-blur-sm text-white flex items-center justify-center gap-3 text-base tracking-wide font-medium">
          ...
          <div className="relative rounded-2xl glass-panel p-4 sm:p-8 border border-slate-200 dark:border-white/15 overflow-hidden shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-mono bg-[#0050FF]/10 dark:bg-[#00D6FF]/10 text-[#0050FF] dark:text-[#00D6FF] border border-[#0050FF]/30 dark:border-[#00D6FF]/30 font-semibold">
