        ...
        <div className="max-w-6xl mx-auto rounded-3xl glass-panel p-6 sm:p-10 border border-slate-200 dark:border-white/15 shadow-lg dark:shadow-[0_25px_70px_rgba(0,0,0,0.8)] relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 mb-8 border-b border-slate-200 dark:border-white/10">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#0050FF]/10 dark:bg-[#00D6FF]/10 border border-[#0050FF]/30 dark:border-[#00D6FF]/30 flex items-center justify-center text-[#0050FF] dark:text-[#00D6FF]">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10">
                  ...
                  <div className="text-[10px] text-green-600 dark:text-green-400 font-mono mt-1">+4.8% this week</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10">
                ...
                <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10">
                  ...
                  <div className="text-[10px] text-[#0050FF] dark:text-[#00D6FF] font-mono mt-1">Top 2% Percentile</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-100/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 rounded-xl glass-panel border border-slate-200 dark:border-white/10">
                  ...
                  <button className="w-full py-2.5 rounded-lg bg-[#0050FF]/15 hover:bg-[#0050FF]/30 text-xs font-semibold text-[#0050FF] dark:text-[#00D6FF] border border-[#0050FF]/40 transition-colors flex items-center justify-center gap-2">
          ...
          {activeTab === 'Predictions' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
              <div className="p-6 rounded-2xl bg-gradient-to-r from-[#0050FF]/20 to-[#00D6FF]/20 border border-[#0050FF]/30 dark:border-[#00D6FF]/40 text-center space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00D6FF]/10 text-[#0050FF] dark:text-[#00D6FF] border border-[#00D6FF]/30 text-xs font-mono">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-8 py-4">
                  ...
                  <div>
                    ...
                    <div className="text-4xl font-extrabold text-[#0050FF] dark:text-[#00D6FF] font-mono">99.4%</div>
                  </div>
                </div>
