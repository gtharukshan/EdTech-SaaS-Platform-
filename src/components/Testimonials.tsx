  ...
  const testimonials = [
    {
      ...
      quote: 'EduNova transformed how I study. The AI Tutor identified my weak spots in integration and quantum mechanics in minutes. My exam confidence skyrocketed.',
    ...
    },
    {
      ...
      quote: 'Traditional textbooks felt static and boring. EduNova made every concept visual and adaptive. The AI exam predictor predicted my exact A* grade!',
